...
package Control_Bindings_Controller_Defaults is
  default_joystick : constant access Game_Input_Translations := new Game_Input_Translations'(
    ...
    Input_Translation'(ev => new Event_Input'(C => Joystick, joy_data => new Controls_Joystick_Data'(J => Button, button => 13)), gi => Up_Press),-- DPad up
    Input_Translation'(ev => new Event_Input'(C => Joystick, joy_data => new Controls_Joystick_Data'(J => Button, button => 12)), gi => Down_Press),-- DPad down
    Input_Translation'(ev => new Event_Input'(C => Joystick, joy_data => new Controls_Joystick_Data'(J => Button, button => 11)), gi => Left_Press),-- DPad left
    Input_Translation'(ev => new Event_Input'(C => Joystick, joy_data => new Controls_Joystick_Data'(J => Button, button => 10)), gi => Right_Press),-- DPad right
    ...
    Input_Translation'(ev => new Event_Input'(C => Joystick, joy_data => new Controls_Joystick_Data'(J => Button, button => 4)), gi => Attack_3_Press),-- RB button
    ...
    Input_Translation'(ev => new Event_Input'(C => Joystick, joy_data => new Controls_Joystick_Data'(J => Axis, axis_num => 0, stick_num => 3, min => default_trigger_axis_min, max => default_trigger_axis_max)), gi => Attack_6_Press),-- RT
    Input_Translation'(ev => new Event_Input'(C => Joystick, joy_data => new Controls_Joystick_Data'(J => Button, button => 9)), gi => Start_Press)-- Start button
  );
