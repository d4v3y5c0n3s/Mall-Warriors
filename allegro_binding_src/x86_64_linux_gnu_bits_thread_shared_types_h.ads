...
package x86_64_linux_gnu_bits_thread_shared_types_h is
  ...
  -- Common definition of pthread_cond_t.  
   type anon999_struct1001 is record
   ...
   type anon999_union1000 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_wseq : aliased Extensions.unsigned_long_long;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:96
         when others =>
            uu_wseq32 : aliased anon999_struct1001;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:101
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type anon999_struct1003 is record
   ...
   with Convention => C_Pass_By_Copy;
   type anon999_union1002 (discr : unsigned := 0) is record
      case discr is
         when 0 =>
            uu_g1_start : aliased Extensions.unsigned_long_long;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:105
         when others =>
            uu_g1_start32 : aliased anon999_struct1003;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:110
      end case;
   end record
   with Convention => C_Pass_By_Copy,
        Unchecked_Union => True;
   type anon999_array1004 is array (0 .. 1) of aliased unsigned;
   type uu_pthread_cond_s is record
      anon2197 : aliased anon999_union1000;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:102
      anon2204 : aliased anon999_union1002;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:111
      uu_g_refs : aliased anon999_array1004;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:112
      uu_g_size : aliased anon999_array1004;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:113
      ...
      uu_g_signals : aliased anon999_array1004;  -- /usr/include/x86_64-linux-gnu/bits/thread-shared-types.h:116
   end record
